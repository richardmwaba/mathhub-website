...
const CourseFiveArea = () => {
    const [courses, setCourses] = useState(course_data.slice(0,5));
            ...
            <div className="container">
                <div className="row g-5">
                    ...
                    <div className="col-lg-9 col-pr--35 order-lg-1">
                        {/* sorting area start */}
                        <SortingArea course_items={course_items} course_list={true} num={showing} setCourses={setCourses} courses={courses} items={items} syllabus="ecz" />
                        {/* sorting area end */}
