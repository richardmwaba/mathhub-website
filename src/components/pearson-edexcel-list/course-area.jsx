...
const CourseFiveArea = () => {
    const [courses, setCourses] = useState(course_data.slice(5,13));
            ...
            <div className="container">
                <div className="row g-5">
                    ...
                    <div className="col-lg-9 col-pr--35 order-lg-1">
                        {/* sorting area start */}
                        <SortingArea course_items={course_items} course_list={true} num={showing} setCourses={setCourses} courses={courses} items={items} syllabus="person=edexcel" />
                        {/* sorting area end */}
